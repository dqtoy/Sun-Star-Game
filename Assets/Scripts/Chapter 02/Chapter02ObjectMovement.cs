...
public class Chapter02ObjectMovement : MonoBehaviour {
    ...
    IEnumerator Delay()
    {
        ...
        switch (GameManager.level2)
        {
            case 1:
                ...
                if (PlayerPrefs.GetInt("chapter02_level") < GameManager.level2 + 1)
                {
                    PlayerPrefs.SetInt("chapter02_level", GameManager.level2 + 1);
                    PlayerPrefs.Save();
                } break;
            case 2:
        ...
        switch (GameManager.level2)
        {
            ...
            case 6:
                Application.LoadLevel("Chapter02Stage0" + (Random.Range(1, 11)));
                break;
