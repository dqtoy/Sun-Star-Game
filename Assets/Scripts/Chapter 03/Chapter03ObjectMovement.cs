...
public class Chapter03ObjectMovement : MonoBehaviour {
    ...
    IEnumerator Delay()
    {
        ...
        switch (GameManager.level3)
        {
            case 1:
                ...
                if (PlayerPrefs.GetInt("chapter03_level") < GameManager.level3 + 1)
                {
                    PlayerPrefs.SetInt("chapter03_level", GameManager.level3 + 1);
                    PlayerPrefs.Save();
                } break;
            case 2:
        ...
        switch (GameManager.level3)
        {
            ...
            case 6:
                Application.LoadLevel("Chapter03Stage0" + (Random.Range(1, 11)));
                break;
