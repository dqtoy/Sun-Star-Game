...
public class Chapter04ObjectMovement : MonoBehaviour {
    ...
    public GameObject Chapter4Object01;
    public GameObject Chapter4Object02;
    ...
    void Start()
    {
        ...
        Instantiate(Chapter4Object01, new Vector3(5, 2.5f, -.5f), Quaternion.identity);
        Instantiate(Chapter4Object02, new Vector3(-5, 2.5f, -.5f), Quaternion.identity);
        Instantiate(Chapter4Object01, new Vector3(5, -2.5f, -.5f), Quaternion.identity);
        Instantiate(Chapter4Object02, new Vector3(-5, -2.5f, -.5f), Quaternion.identity);
    ...
    IEnumerator Delay()
    {
        ...
        switch (GameManager.level4)
        {
            case 1:
                ...
                if (PlayerPrefs.GetInt("chapter04_level") < GameManager.level4 + 1)
                {
                    PlayerPrefs.SetInt("chapter04_level", GameManager.level4 + 1);
                    PlayerPrefs.Save();
                } break;
            case 2:
        ...
        switch (GameManager.level4)
        {
            ...
            case 6:
                Application.LoadLevel("Chapter04Stage0" + (Random.Range(1, 11)));
                break;
