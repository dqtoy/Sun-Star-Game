...
public class Chapter05ObjectMovement : MonoBehaviour {
    ...
    public GameObject Chapter5Object01;
    public GameObject Chapter5Object02;
    ...
    void Start()
    {
        ...
        Instantiate(Chapter5Object01, new Vector3(5, 2.5f, -.5f), Quaternion.identity);
        Instantiate(Chapter5Object01, new Vector3(5, -2.5f, -.5f), Quaternion.identity);
        Instantiate(Chapter5Object02, new Vector3(-5, 2.5f, -.5f), Quaternion.identity);
        Instantiate(Chapter5Object02, new Vector3(-5, -2.5f, -.5f), Quaternion.identity);
    ...
    void Update()
    {
        ...
        if (START)
        {
            if (position)
            {
                for (int i = 0; i < ballsCount; i++)
                {
                    if (redBallClones[i].transform.position.x > slider.transform.position.x)
                        red++;
                    if (blueBallClones[i].transform.position.x < slider.transform.position.x)
                        blue++;
                }
    ...
    IEnumerator Delay()
    {
        ...
        switch (GameManager.level5)
        {
            case 1:
                ...
                if (PlayerPrefs.GetInt("chapter05_level") < GameManager.level5 + 1)
                {
                    PlayerPrefs.SetInt("chapter05_level", GameManager.level5 + 1);
                    PlayerPrefs.Save();
                } break;
            case 2:
        ...
        switch (GameManager.level5)
        {
            ...
            case 6:
                Application.LoadLevel("Chapter05Stage0" + (Random.Range(1, 11)));
                break;
